...
最新功能：[Research Cite多格式引用](verification/research-cite-2026-09-18.md)，已发表3篇可切换Text/BibTeX/RIS，查看、复制及下载，并可打开出版页；投稿论文无入口。用户已另行要求更新文档并上传，本轮发布结果见[Cite发布记录](verification/release-cite-2026-09-18.md)。此前仅Bib和本地阶段记录保留作为历史。
